  ...
  return (
    <form className={style.container} onSubmit={(e)=>handleSubmit(e)} onChange={(e)=>handleChange(e)}>
      ...
      <label>
        ...
        <input className={style.input}  value={inputs.username}name="username" type="text" />
        <div className={style.errores}>{err.username.errores[err.username.indice]}</div>
      <label>
        Password
      </label>
        <input className={style.input} value={inputs.password}name="password" type="password" />
        <div className={style.errores}>{err.password.errores[err.password.indice]}</div>
      <label>
        Name
      </label>
        <input className={style.input} value={inputs.name}name="name" type="text" />
        <div className={style.errores}>{err.name.errores[err.name.indice]}</div>
      <label>
        Last Name
      </label>
        <input className={style.input} value={inputs.lastName}name="lastName" type="text" />
        <div className={style.errores}>{err.lastName.errores[err.lastName.indice]}</div>
      <label>
        Email
      </label>
        <input className={style.input} value={inputs.email}name="email" type="email" />
        <div className={style.errores}>{err.email.errores[err.email.indice]}</div>
      <label>
        GitHub
      </label>
        <input className={style.input} value={inputs.github}name="github" type="text" />
        <div className={style.errores}>{err.github.errores[err.github.indice]}</div>
      <label>
        Avatar
      </label>
        <input className={style.input} value={inputs.avatar}name="avatar" type="image" />
      <label>
        About
      </label>
        <textarea className={style.input} value={inputs.about}name="about" type="text"></textarea>
      <label>
        Tags
      </label>
        <input className={style.input} value={inputs.tags}name="tags" type="text" />
